...
export default function ARAgeingPage() {
  ...
  const fetchReport = async () => {
    setIsLoading(true);
    try {
      const response = await fetch(`/api/reports/ar-ageing?date=${date}`, {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">AR Ageing</h1>
            <p className="text-muted-foreground">Unpaid student invoices by age</p>
          </div>
        </div>
        <ReportToolbar 
