...
export async function GET(req: NextRequest) {
  return withAuth(req, async (authReq) => {
    ...
    const content = await ReportExporter.export(format, report.rows, columns, "AP Ageing Report");
    return ReportExporter.getResponse(format, content, "AP Ageing Report");
  });
}
