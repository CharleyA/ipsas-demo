...
export async function GET(req: NextRequest) {
  return withAuth(req, async (authReq) => {
    ...
    const content = await ReportExporter.export(exportFormat, data, columns, "Statement of Cash Flows", {
    ...
    return ReportExporter.getResponse(exportFormat, content, "Cash Flow Statement");
  });
}
